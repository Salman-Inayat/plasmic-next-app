...
export function Group6Icon(props: Group6IconProps) {
  ...
  return (
    ...
    >
      ...
      <path
        d={
          "M22.727 0h-2.273v2.273h2.273V0zm4.546 0H25v2.273h2.273V0zm4.545 0h-2.273v2.273h2.273V0zm4.546 0H34.09v2.273h2.273V0zm2.272 0h-2.272v2.273h2.272V0zm9.091 0h-2.272v2.273h2.272V0zm6.818 0h-2.272v2.273h2.272V0zm2.273 0h-2.273v2.273h2.273V0zm4.546 0H59.09v2.273h2.273V0zm4.545 0h-2.273v2.273h2.273V0zm2.273 0h-2.273v2.273h2.273V0zm2.272 0h-2.272v2.273h2.272V0zM75 0h-2.273v2.273H75V0z"
        }
        fill={"currentColor"}
      ></path>
    </svg>
