...
export function Group3Icon(props: Group3IconProps) {
  ...
  return (
    ...
    >
      ...
      <path
        d={
          "M13.636 0h-2.272v2.273h2.272V0zm2.273 0h-2.273v2.273h2.273V0zm4.545 0h-2.272v2.273h2.273V0z"
        }
        fill={"currentColor"}
      ></path>
      ...
      <path
        d={
          "M22.727 0h-2.273v2.273h2.273V0zM25 0h-2.273v2.273H25V0zm4.545 0h-2.272v2.273h2.272V0zm2.273 0h-2.273v2.273h2.273V0zm4.546 0H34.09v2.273h2.273V0zm11.363 0h-2.272v2.273h2.272V0zm4.546 0H50v2.273h2.273V0zm2.272 0h-2.272v2.273h2.272V0zm6.819 0H59.09v2.273h2.273V0zm2.272 0h-2.272v2.273h2.272V0zm2.273 0h-2.273v2.273h2.273V0zm2.273 0h-2.273v2.273h2.273V0z"
        }
        fill={"currentColor"}
      ></path>
