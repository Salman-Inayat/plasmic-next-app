...
export type IconoirtwitterIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function IconoirtwitterIcon(props: IconoirtwitterIconProps) {
...
export default IconoirtwitterIcon;
/* prettier-ignore-end */
