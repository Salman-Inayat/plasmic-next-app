...
// Plasmic Project: sozjy886PYVRnZF8m3eey1
// Component: gPJORQ797Jy
...
import projectcss from "./plasmic_blank_project.module.css"; // plasmic-import: sozjy886PYVRnZF8m3eey1/projectcss
import sty from "./PlasmicButton2.module.css"; // plasmic-import: gPJORQ797Jy/css

import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: A9PhFlRuUtB/icon
import Icon38Icon from "./icons/PlasmicIcon__Icon38"; // plasmic-import: Kj1hesiKscC/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__mVnM)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon38Icon
                className={classNames(projectcss.all, sty.svg__wsBgL)}
                role={"img"}
              />
            ),
